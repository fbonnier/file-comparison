...
def check_array_size_warning (self, array1, array2):
...
def check_file_formats (self, file1, file2):
    try:
        neo.io.get_io(file1.url + file1.name)
        neo.io.get_io(file2.url + file2.name)
        return True
    except Exception as e:
